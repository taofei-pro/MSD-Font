...
def generate_with_model_direct(font_path, chars_info_path, output_dir, rec_model_path, trans_model_path, batch_size=16):
    """使用训练好的模型生成字体 - 直接加载权重版本"""
    # 加载字符信息
...
def main():
    parser = argparse.ArgumentParser(description="使用训练好的模型生成字体 - 直接加载权重版本")
